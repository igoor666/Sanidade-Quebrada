...
vida_personagem_1 = 100
vida_personagem_2 = 90
vida_inimigo = 80
print("vida_personagem_1")
print("vida_personagem_2")
print("vida_inimigo")
...
for i in range(1,3):
        ...
        elif personagem == 1 and ataque == 2:  print("lucas tem 85 de vida restante")
        elif personagem == 1 and ataque == 3:  print("lucas tem 70 de vida restante")
        elif personagem == 2 and ataque == 1:    print("helena tem 70 de vida restante")
        elif personagem == 2 and ataque == 2:   print("helena tem 75 de vida restante")
        elif personagem == 2 and ataque == 3: print("helena tem 60 de vida restante")

        print("vida da marionete quebrada")
        ...
        elif personagem == 2 and ataque == 1:    print("a marionete quebrada tem 55 de vida restante")
